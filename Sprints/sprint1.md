...
| US#07 | **En tant que** utilisateur, **je souhaite**, une fois sur la page “Accueil”, cliquer sur le nom d’un projet qui est listé **afin de** se rendre sur la page d’accueil de ce projet. | High | 1 | DONE |
...
| US#17 | **En tant que** PO ou CP, **je souhaite** cliquer sur le bouton “Supprimer” d’une *issue* **afin de** supprimer une *issue*. | High | 1 | DONE |
| US#18 | **En tant que** utilisateur, **je souhaite** cliquer sur l’onglet “Issues” **afin de** afficher la liste de toutes les *issues* du projet. | High | 1 | DONE |
| US#19 | **En tant que** utilisateur, **je souhaite** cliquer sur une issue **afin de** consulter les informations relatives à cette issue (cf. spécifications US#15), les tâches qui lui sont liées (leurs descriptions et états) et le sprint à laquelle elle est affectée (son identifiant). | High | 1 | DONE |
| **Total** | | | **18** | |
